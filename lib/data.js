...
// While false, Order Now CTAs open the branch picker (delivery-app links).
...
// `platform` is shown on the card, so branches can live on different
// delivery apps — not every branch is listed on Deliveroo.
export const BRANCHES = [
  ...
  },
  {
    id: 'arjan',
    name: 'Arjan',
    area: 'Arjan, Al Barsha South',
    lat: 25.068,
    lng: 55.239,
    platform: 'Talabat',
    orderUrl: 'https://www.talabat.com/uae/house-of-chops-dh-kitchen-arjan',
  },
];
...
export const SITE = {
  ...
  instagram: 'https://instagram.com/houseofchops.ae',
  instagramHandle: '@houseofchops.ae',
  city: 'Dubai, UAE',
