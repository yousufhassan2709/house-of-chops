...
export const PRODUCTS = {
  classic: {
    ...
    desc:
      'Marinated in our signature honey BBQ & roasted garlic herb blend. Served with seasoned fries.',
    price: 99,
    tag: null,
  ...
  large: {
    ...
    desc:
      'Same bold marinade, bigger feast. Served with seasoned fries. Perfect for sharing.',
    price: 119,
    tag: null,
